...
def print_logo():
    console = Console()
    console.print("[blue bold]         ____  ____  _____________  _____")
    console.print("[blue bold]        / __ \/ __ `/ ___/ ___/ _ \/ ___/")
    console.print("[blue bold]       / /_/ / /_/ / /  (__  )  __/ /    ")
    console.print("[blue bold]      / .___/\__,_/_/  /____/\___/_/     ")
...
def parse_categories_file(path: str) -> dict:
    if Path(path).exists():
        with open(path, "r", encoding="utf-8") as file:
            return json.load(file)
    else:
        raise Exception(f"Путь {path} не найден!")
